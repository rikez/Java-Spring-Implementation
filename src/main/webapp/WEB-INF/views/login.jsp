...
<link href="${cssPath }/css/login.css" rel="stylesheet" />
</head>
<body>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="login-form" servletRelativeAction="/login" method="post" style="display: block;">
								...
								<form:form id="register-form" servletRelativeAction="/signup" method="post" role="form" style="display: none;">
									<div class="form-group">
